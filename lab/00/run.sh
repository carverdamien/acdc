...
docker-compose -f unrestricted.yml exec host bash -c '! [ -d /rootfs/sys/fs/cgroup/memory/consolidate ] || find /rootfs/sys/fs/cgroup/memory/consolidate -type d -exec rmdir {} \;'
